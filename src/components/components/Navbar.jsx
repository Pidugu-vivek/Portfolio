...
import seo from "../../assets/Seo isometric composition with human characters.json";
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto self-start">
        ...
        >
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex">
            Pidugu &nbsp;V
            <span className="cursor-pointer sm:block hidden">ivek</span>
          </p>
        </Link>
        <ul className="list-none hidden sm:flex flex-row gap-10">
          {navLinks.map((link) => (
            <li
              ...
              onClick={() => {
                if (!link.url) setActiveSection(link.id);
              }}
            >
              <a
